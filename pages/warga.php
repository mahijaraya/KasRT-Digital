...
// Fungsi: Filter, search, edit, hapus
// ==============================================
...
function filterTable() {
    ...
    rows.forEach(row => {
        // Skip jika baris adalah "belum ada data"
        ...
        const status = statusCell.includes('Aktif') ? 'Aktif' : 'Tidak Aktif';
...
function editWarga(id) {
    // Ambil data dari baris tabel (sementara, nanti akan diganti dengan AJAX)
    // Untuk sementara menggunakan data dari tabel, nanti Anggota 3 akan membuat API endpoint
